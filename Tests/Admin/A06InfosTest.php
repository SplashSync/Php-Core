 ...
 */
class A06InfosTest extends BaseCase {
    ...
    public function VerifyResponse($Data)
    {
        ...
        $this->assertTrue( 
                ...
                "You must provide a logo for your module. Pass an image url on 'logourl' or a ra logo contents on 'logoraw' information." 
                );  
        ...
        if ( !empty($Data["logoraw"]) ) {
            $this->assertArrayInternalType($Data, "logoraw",    "string",   "Module Logo Raw is not a string. " . $FilesTooltip);
        }
